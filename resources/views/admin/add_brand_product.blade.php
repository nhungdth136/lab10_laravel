                    ...
                    <div class="position-center">
                        <form role="form" action="{{ asset('/save-brand-product') }}" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="brand_product_name" class="form-control" data-validation="required"
                            ...
                            <div class="form-group">
                                ...
                                <select name="brand_product_status" class="form-control input-sm m-bot15" data-validation="required">
